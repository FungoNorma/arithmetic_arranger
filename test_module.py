...
test_cases = [
    ...
    pytest.param(
        ...
        'Expected calling "arithmetic_arranger()" with +\
        more than five problems to return "Error: Too many problems."',
        id='test_too_many_problems'),
    pytest.param(
        [['3 / 855', '3801 - 2', '45 + 43', '123 + 49']],
        "Error: Operator must be '+' or '-'.",
        '''Expected calling "arithmetic_arranger()" with +\
        a problem that uses the "/" operator to return "Error: Operator must +\
        be '+' or '-'."''',
    ...
    pytest.param(
        ...
        'Expected calling "arithmetic_arranger()" with +\
        a problem that has a number over 4 digits long to+\
    ...
    pytest.param(
        ...
        'Expected calling "arithmetic_arranger()" with+\
        a problem that contains a letter character in +\
        the number to return "Error: Numbers must only contain digits."',
        id='test_only_digits'),
    pytest.param(
        [['3 + 855', '988 + 40'], True],
        '    3      988\n'
        ...
        calling "arithmetic_arranger()" with ["3 + 855", "988 + 40"] and +\
    ...
    pytest.param(
        ...
        'Expected solutions to be correctly displayed in output when +\
        calling "arithmetic_arranger()" with five arithmetic problems and +\
        a second argument of `True`.',
